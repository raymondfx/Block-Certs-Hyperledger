...
export class ProductComponent implements OnInit {
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.serviceProduct.updateAsset(form.get('certificateId').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.certificatetype) {
        formObject.certificatetype = result.certificatetype;
      } else {
        formObject.certificatetype = null;
      }
